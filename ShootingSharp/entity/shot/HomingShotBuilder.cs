...
{
    public class HomingShotBuilder<T> : ShotBuilder<T> where T : Shot
    {
        private position.SSPosition pos;
        private int meta;
        private position.SSPosition target;

        public HomingShotBuilder(position.SSPosition initPos, int metaData, position.SSPosition target)
        {
            this.pos = initPos;
            this.meta = metaData;
            this.target = target;
        ...
        public HomingShotBuilder(interfaces.IHasSSPosition shooter, int metaData, position.SSPosition target)
        {
        ...
        protected override void SetBuilder(T shot)
        {
            ...
            shot.Type = Shot.ShotType.Homing;
